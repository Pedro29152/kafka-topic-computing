package com.estudo.performance.kafka.producer.config;

import com.estudo.performance.config.KafkaConfigData;
import com.estudo.performance.config.KafkaProducerConfigData;
import com.estudo.performance.kafka.producer.config.service.KafkaProducerCallback;
import com.estudo.performance.kafka.producer.config.service.impl.KafkaProducerDefaultCallback;
...
public class KafkaProducerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public KafkaProducerCallback kafkaProducerCallback() {
        return new KafkaProducerDefaultCallback();
    }
}
